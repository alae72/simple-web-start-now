...
const SitemapPage = () => {
  const siteLinks = [
    { title: 'Home', path: '/', description: 'Discover beautiful vacation properties in Martil' },
    { title: 'Properties', path: '/properties', description: 'Browse all available properties' },
    { title: 'About Us', path: '/about', description: 'Learn about MartilHaven and our story' },
      ...
      <main className="flex-grow py-16">
        <div className="container-custom max-w-4xl">
          ...
          <p className="text-gray-600 mb-12">
            Find all the pages and sections available on MartilHaven website.
          </p>
